            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a style="color: green;" href="index.php?c=department">Department</a></li>
                    ...
                    <div class="card card-success">
                        ...
                        <div class="card-body">
                            <form enctype="multipart/form-data" method="post" action="index.php?c=department&m=handle-add">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        <button class="btn btn-success btn-lg" type="submit" name="btnSave"> Save </button>
                                    </div>
                                </div>
                            </form>
                        </div>
